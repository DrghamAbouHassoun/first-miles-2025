...
const Menu = () => {
  ...
  return (
    <div className={`w-full h-screen overflow-y-auto fixed top-0 left-0 bg-fm-green flex justify-center items-center ${isOpen ? "translate-y-0" : "-translate-y-full"} transition-transform duration-700`}>
