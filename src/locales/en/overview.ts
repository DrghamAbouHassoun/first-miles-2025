export default {
  ...
  geographicPresenceContent: {
    ...
    exportMarketsTitle: "Export Markets and Volumes",
    markets: {
      uae: {
        name: "UAE",
        tons: "1,968 tons",
  ...
  yearInReviewContent: {
    ...
    slider: {
      ...
      items: {
        ...
        february: {
          month: "February",
          title: "Platinum sponsorship of Capital Markets Forum 2025",
          desc: "We participated as a Platinum sponsor at the Capital Markets Forum 2025 in Riyadh, reinforcing our role in shaping conversations about Saudi Arabia's capital markets.",
        },
        april: {
          month: "April",
        ...
        may: {
          month: "May",
          title: "Launch of WhatsApp live chat service",
          desc: "We introduced live customer support through WhatsApp, providing faster, more convenient service and strengthening real-time engagement with customers across the Kingdom.",
        },
        july: {
          month: "July",
          title: "FSSC 22000 V6 certification achieved",
          desc: "All First Mills plants received FSSC 22000 V6 certification, recognized by GFSI, underscoring our commitment to food safety and operational excellence.",
        },
        august: {
          month: "August",
