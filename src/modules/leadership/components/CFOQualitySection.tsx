            ...
            <div className="py-10 md:py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-8">
                ...
                <SlideTopAnimation className="md:row-span-3 pb-6 md:pb-0 md:pe-8">
                  <p
                    className="text-white font-bold text-6xl md:text-7xl leading-none mb-2"
                    dir="ltr"
                  >
                ...
                <SlideTopAnimation className=" pb-6 md:pb-0 md:pe-8">
                  <p
                    className="text-black font-bold text-5xl leading-none mb-2"
                    dir="ltr"
                  >
                ...
                <SlideTopAnimation className="pb-6 md:pb-0">
                  <p
                    className="text-white font-bold text-5xl leading-none mb-2"
                    dir="ltr"
                  >
                    {data.stats.trainingCourses.number}
                  </p>
                  <p className="text-sm black leading-snug">
                ...
                <SlideTopAnimation className=" pb-6 md:pb-0 md:pe-8">
                  <p
                    className="text-white font-bold text-4xl leading-none mb-2"
                    dir="ltr"
                  >
                ...
                <SlideTopAnimation className="pb-6 md:pb-0">
                  <p
                    className="black font-bold text-5xl leading-none mb-2"
                    dir="ltr"
                  >
                  ...
                  <p className="text-xs black/70 leading-snug">
                ...
                <SlideTopAnimation className=" pb-6 md:pb-0 md:pe-8">
                  <p
                    className="black font-bold text-4xl md:text-5xl leading-none mb-2"
                    dir="ltr"
                  >
                  ...
                  <p className="text-xs black/70 leading-relaxed">
                ...
                <SlideTopAnimation className=" pb-6 md:pb-0 md:pe-8">
                  <p
                    className="black font-bold text-4xl md:text-5xl leading-tight mb-2 whitespace-pre-line"
                    dir="ltr"
                  >
