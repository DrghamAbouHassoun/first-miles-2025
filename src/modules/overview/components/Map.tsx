...
const Map = () => {
  ...
  return (
    <div dir={isRtl ? "rtl" : "ltr"} className="w-full bg-fm-green py-16">
      ...
      <div
        className={`flex justify-center px-2 sm:px-0 lg:absolute lg:bottom-6  left-16 ${isRtl ? "lg:left-auto lg:right-6 xl:right-16" : ""}`}
      >
