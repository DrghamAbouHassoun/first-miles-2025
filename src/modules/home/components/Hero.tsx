...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div
        className={`bg-fm-green w-full h-screen overflow-hidden hidden lg:flex ${lang === "ar" ? "flex-row" : ""} justify-center items-center relative px-4 lg:px-16 `}
      >
        ...
        <div
          className={` w-full h-full mx-auto max-w-337.5 min-h-screen flex ${lang === "ar" ? "flex-row-reverse" : ""} justify-center items-center animate-move-left-40 animate-delay-4s z-10`}
        >
          <div className="text-white flex-1 flex flex-col max-w-120">
            <div className="overflow-hidden">
              <h1 className="text-2xl font-thin animate-move-down animate-delay-3s">
                {t("hero.title")}
              </h1>
            </div>
            <div className="overflow-hidden">
              <p
                className={`text-5xl font-bold pt-4 animate-move-down animate-delay-3s py-2 ${lang === "ar" ? "py-2" : ""}`}
              >
                {t("hero.subtitle1")}
              </p>
            </div>
            <div className="overflow-hidden">
              <p
                className={`text-5xl font-bold animate-move-down animate-delay-3s  ${lang === "ar" ? "py-2" : ""}`}
              >
                {t("hero.subtitle2")}
              </p>
            </div>
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex items-end">
          ...
          <div className="left-0 absolute animate-fade-top">
      ...
      <div className="relative w-full h-screen overflow-hidden bg-fm-green flex lg:hidden justify-center items-center pt-42">
        ...
        <div className="w-full  mx-auto max-w-337.5 max-h-screen flex flex-col items-center z-10 mb-4">
          <div className="text-white flex flex-col w-full h-[50%] flex-1 px-4">
            <div className="overflow-hidden">
              <h1 className="text-lg font-thin animate-move-down animate-delay-3s">
                {t("hero.title")}
              </h1>
            </div>
            <div className="overflow-hidden">
              <p className="text-3xl font-bold animate-move-down animate-delay-3s">
                {t("hero.subtitle1")}
              </p>
            </div>
            <div className="overflow-hidden">
